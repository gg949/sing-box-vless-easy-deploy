...
MENU
    ...
    case "${opt:-}" in
        ...
        22) action_argo_stop_temp || true ;;
        23) action_uninstall; exit 0 ;;
        24) action_remove_ss || true ;;
        25) action_remove_hy2 || true ;;
        26) action_remove_reality || true ;;
        27) action_remove_vless_ws || true ;;
        0) exit 0 ;;
        *) warn "无效选项" ;;
    esac
